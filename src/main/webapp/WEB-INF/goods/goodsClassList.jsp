...
Ext.onReady(function (){
	...
	function add() {
	    ...
	    var win = new Ext.Window({
	        ...
	        items: [{
	            ...
	            items: [
	               { fieldLabel: "分类名称", name: "className", allowBlank : false, blankText: "请输入分类名" },	                           
	               {
	            		xtype : 'combo',
	            		name: "inUse",
	            		fieldLabel : '是否可用',
	                     ...
	                     Ext.getCmp("form1").getForm().submit(
	        					 {
	        						 ...
	        						 waitMsg:'请稍候',
	        						 waitTitle:'正在添加',
	        						 url:'${ctx}/goods/goodsClass/addGoodsClass',
	...
	function edit() {
	    ...
	    var id,className,inUse;
	    if (selRecords.length >= 1) {
	        id = selRecords[0].get("id");
	        className = selRecords[0].get("className");
	    ...
	    var win = new Ext.Window({
	        ...
	        items: [{
	            ...
	            items: [
	               ...
	               { fieldLabel: "分类名称", name: "className", allowBlank : false, blankText: "请输入分类名称",value:className },
	               {
	            		xtype : 'combo',
	            		name: "inUse",
	            		fieldLabel : '是否可用',
	                    ...
	                    Ext.getCmp("form1").getForm().submit(
	        					 {
	        						 ...
	        						 waitMsg:'请稍候',
	        						 waitTitle:'正在提交',
	        						 url:'${ctx}/goods/goodsClass/updateGoodsClass',
	        						 success:function(form,action){
	        							 Ext.MessageBox.show({					
	                                         width:150,
	                                         title:"更新成功",
	    ...
	    var ids = "";
	            ...
	            Ext.Msg.confirm("提示", "确定要删除吗?", function (btn) {
	                if (btn == "yes") {
	                    ...
	                    Ext.Ajax.request({
	                        url: "${ctx}/goods/goodsClass/betchDelGoodsClass/"+ids,
	...
	var store = Ext.create("Ext.data.JsonStore", {
        ...
        proxy: {
            type: "ajax",
            url: "${ctx}/goods/goodsClass/getGoodsClass",
	...
	var dataGrid=Ext.create('Ext.grid.Panel', {
	    ...
	    columns: [
	              rn,
	        { flex : 5,text: '分类名',  dataIndex: 'className' },
