	...
	Ext
			.onReady(function() {
														...
														.submit(
																{
																	...
																	waitMsg : '请稍候',
																	waitTitle : '正在添加',
																	url : '${ctx}/goods/goodsNumRule/addGoodsNumRule',
																	success : function(
																			form,
																			action) {
																		Ext.MessageBox
				...
				function edit() {
					...
					var id, autoCreate, prefix, inUse;
					if (selRecords.length >= 1) {
						id = selRecords[0].get("id");
						autoCreate = selRecords[0].get("autoCreate");
						prefix = selRecords[0].get("prefix");
														...
														.submit(
																{
																	...
																	waitMsg : '请稍候',
																	waitTitle : '正在提交',
																	url : '${ctx}/goods/goodsNumRule/updateGoodsNumRule',
																	success : function(
																			form,
																			action) {
																		Ext.MessageBox
							...
							.confirm(
									...
									function(btn) {
										if (btn == "yes") {
											...
											Ext.Ajax
													.request({
														url : "${ctx}/goods/goodsNumRule/betchDelGoodsNumRule/"
																+ ids,
														success : function(
																reponse, option) {
															json = eval("("
				...
				var store = Ext.create("Ext.data.JsonStore", {
					...
					proxy : {
						type : "ajax",
						url : "${ctx}/goods/goodsNumRule/getGoodsNumRule",
						actionMethods : {
							read : 'POST'
						},
						extraParams : {},
