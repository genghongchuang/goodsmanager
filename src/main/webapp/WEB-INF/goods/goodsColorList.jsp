...
Ext.onReady(function (){
	...
	function add() {
	    ...
	    var win = new Ext.Window({
	        ...
	        items: [{
	            ...
	            items: [
	               { fieldLabel: "颜色", name: "colorName", allowBlank : false, blankText: "请输入颜色" },	                           
	               {
	            		xtype : 'combo',
	            		name: "inUse",
	            		fieldLabel : '是否可用',
	                     ...
	                     Ext.getCmp("form1").getForm().submit(
	        					 {
	        						 ...
	        						 waitMsg:'请稍候',
	        						 waitTitle:'正在添加',
	        						 url:'${ctx}/goods/goodsColor/addGoodsColor',
	...
	function edit() {
	    ...
	    var id,colorName,inUse;
	    if (selRecords.length >= 1) {
	        id = selRecords[0].get("id");
	        colorName = selRecords[0].get("colorName");
	    ...
	    var win = new Ext.Window({
	        ...
	        items: [{
	            ...
	            items: [
	               ...
	               { fieldLabel: "颜色", name: "colorName", allowBlank : false, blankText: "请输入颜色",value:colorName },
	               {
	            		xtype : 'combo',
	            		name: "inUse",
	            		fieldLabel : '是否可用',
	                    ...
	                    Ext.getCmp("form1").getForm().submit(
	        					 {
	        						 ...
	        						 waitMsg:'请稍候',
	        						 waitTitle:'正在提交',
	        						 url:'${ctx}/goods/goodsColor/updateGoodsColor',
	        						 success:function(form,action){
	        							 Ext.MessageBox.show({					
	                                         width:150,
	                                         title:"更新成功",
	    ...
	    var ids = "";
	            ...
	            Ext.Msg.confirm("提示", "确定要删除吗?", function (btn) {
	                if (btn == "yes") {
	                    ...
	                    Ext.Ajax.request({
	                        url: "${ctx}/goods/goodsColor/betchDelGoodsColor/"+ids,
	...
	var store = Ext.create("Ext.data.JsonStore", {
        ...
        proxy: {
            type: "ajax",
            url: "${ctx}/goods/goodsColor/getGoodsColor",
	...
	var dataGrid=Ext.create('Ext.grid.Panel', {
	    ...
	    columns: [
	              rn,
	        { flex : 5,text: '颜色',  dataIndex: 'colorName' },
